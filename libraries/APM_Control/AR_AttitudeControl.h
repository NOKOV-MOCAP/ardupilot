...
public:
    ...
    float get_lateral_out_speed(float desired_speed, bool motor_limit_low, bool motor_limit_high, float cruise_speed, float cruise_throttle, float dt);
    ...
    float get_lateral_out_stop(bool motor_limit_low, bool motor_limit_high, float cruise_speed, float cruise_throttle, float dt, bool &stopped);
    ...
    bool get_right_speed(float &speed) const;
    ...
    bool speedY_control_active() const;
    ...
    float get_desired_speedY_accel_limited(float desired_speed, float dt) const;
...
private:
    ...
    AP_Float _lateral_accel_max;   
    AP_Float _lateral_decel_max;
